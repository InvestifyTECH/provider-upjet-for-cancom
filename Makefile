...
PROJECT_NAME ?= provider-upjet-for-cancom
PROJECT_REPO ?= github.com/InvestifyTECH/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= cancom/cancom
export TERRAFORM_PROVIDER_REPO ?= https://github.com/cancom/terraform-provider-cancom
export TERRAFORM_PROVIDER_VERSION ?= 0.1.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-cancom
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/cancom/terraform-provider-cancom/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-cancom_v0.1.2
...
REGISTRY_ORGS ?= ghcr.io/investifytech
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= ghcr.io/investifytech
# NOTE(hasheddan): skip promoting on xpkg.crossplane.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= ghcr.io/investifytech
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-upjet-for-cancom: do.build.images
