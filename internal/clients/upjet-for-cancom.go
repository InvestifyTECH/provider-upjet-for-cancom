...
import (
	...
	clusterv1beta1 "github.com/InvestifyTECH/provider-upjet-for-cancom/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/InvestifyTECH/provider-upjet-for-cancom/apis/namespaced/v1beta1"
)

const (
	keyRole            = "role"
	keyServiceRegistry = "service_registry"
	keyToken           = "token"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal upjet-for-cancom credentials as JSON"
)
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		if v, ok := creds[keyServiceRegistry]; ok {
			ps.Configuration[keyServiceRegistry] = v
		}
